	...
	return (
		<>
			...
			<footer className="w-full pb-6 border-t bg-[#173C37] text-white">
				<div className="w-full max-w-[2000px] mx-auto px-4 md:px-6 lg:px-8">
					{/* White Divider Line */}
					<div className="w-full h-px bg-white/30 relative z-10 mb-12"></div>
					<div className="grid grid-cols-1 md:grid-cols-2 gap-8">
						...
						<div className="flex flex-col space-y-6">
							...
							<div className="flex space-x-6">
								...
								<a
									href="https://www.instagram.com/legacyinorder/"
						...
						{/* Column 2: Explore, Support, and Contact Us */}
					...
					{/* White Divider Line */}
					<div className="mt-12 w-full h-px bg-white/30 relative z-10"></div>
					...
					<div className="pt-8">
						<div className="flex flex-col lg:flex-row justify-between items-start gap-6">
							...
							<p className="text-[0.75rem] font-normal text-white/60 max-w-2xl">
								© LegacyInOrder Ltd (Company No. 16597440) • LagacyInOrder is
								not a law firm and is not regulated by the Solicitors Regulation
								Authority (SRA). Our online will writing service is an online
								service providing legal forms and information to allow you to
								draft your own will. Our telephone service provides guidance, we
								do not provide bespoke advice or tax advice.
							</p>
						</div>
					</div>
				</div>
