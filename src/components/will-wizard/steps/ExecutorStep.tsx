	...
	return (
		<div className="space-y-6">
			...
			<div className="text-[#696868] text-[0.875rem] -mt-4">
				Executors are the people responsible for carrying out the terms of your
				Will.
			</div>
			<div className="text-[#696868] text-[0.875rem] -mt-4">
				You should appoint at least one executor (maximum of four). It is
				recommended to have a backup executor in case the primary executor is
				unable to serve.
			</div>
			<div className="text-[#696868] text-[0.875rem] -mt-4">
				You can appoint a professional executor if your family might struggle
				with the role, you want someone impartial to handle disputes, you do not
				have a suitable relative or friend, or you need a back-up because your
				other executors live abroad.
			</div>
